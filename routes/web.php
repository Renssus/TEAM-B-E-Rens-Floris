...
Route::get('/{brand_id}/{brand_slug}/', [BrandController::class, 'show'])->name('brands.show');

// Detail page for a manual
Route::get('/{brand_id}/{brand_slug}/{manual_id}/', [ManualController::class, 'show'])->name('manuals.show');
...
Route::get('/brands/{letter}', [BrandController::class, 'showByLetter'])->name('brands.letter');